...
export const NOTIFICATIONS = [
  ...
  {
    key: 'portal.member_joined',
    label: 'Client joined the portal',
    description: 'A client accepts their customer-portal invite and sets up an account.',
    audience: 'broadcast',
    group: 'Client portal',
    channel: 'general',
  },
  {
    key: 'portal.doc_uploaded',
    label: 'Client uploaded a file',
    description: 'A client uploads a document or brand guidelines via the customer portal.',
    audience: 'broadcast',
    group: 'Client portal',
    channel: 'general',
  },
  ...
  {
    key: 'portal.partner_interest',
    label: 'Client interested in Partner Programme',
    description: 'A client clicks "I\'m interested" on the Partner Programme card in the customer portal.',
    audience: 'broadcast',
    group: 'Client portal',
    channel: 'finance',
  },
