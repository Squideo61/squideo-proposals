...
export function FinanceView({ onBack, onOpenDeal }) {
  ...
  const firstTab = isSales
    ? { view: salesView, loading: !salesFin, label: 'Sales' }
    : { view, loading, label: 'Income' };
        ...
        <>
          ...
          <div style={{ background: 'white', border: '1px solid ' + BRAND.border, borderRadius: 12, padding: isMobile ? 12 : 20, marginBottom: 20 }}>
            <h3 style={{ margin: '0 0 12px', fontSize: 13, fontWeight: 700, color: BRAND.muted, textTransform: 'uppercase', letterSpacing: 0.6 }}>
              {isSales ? 'Cash generated (ex-VAT)' : 'Net revenue (ex-VAT)'} — {firstTab.view.periodLabel}
            </h3>
            {firstTab.loading ? (
              ...
              <ResponsiveContainer width="100%" height={320}>
                <BarChart data={firstTab.view.chart} margin={{ top: 8, right: 16, left: 0, bottom: 8 }}>
                  ...
                  <Bar dataKey="net" name={isSales ? 'Cash generated (ex-VAT)' : 'Net revenue (ex-VAT)'} fill={BRAND.blue} radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            )}
          </div>
